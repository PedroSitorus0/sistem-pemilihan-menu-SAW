...
<head>
    ...
    <style>
        ...
        .notfound-copy {
            ...
            right: 10%;
            text-align: right;
            z-index: 10; /* Memastikan teks berada di atas bintang-bintang */
        }
        h1 {
            font-weight: 700;
            font-size: 40px;
        ...
        input[type=text]:focus {
            border-bottom: 2px solid #5581d4;
        }
        /* mobile test */
...
<body>
    ...
    <div class="notfound-copy">
        <svg aria-labelledby="404" alt="404 Page not found" class="not-found" viewBox="0 0 600 225">
        ...
        <form action="{{ url('/') }}" method="GET" style="display:inline-block; margin-bottom: 20px;">
            <input id="input1" type="text" name="q" placeholder="Search">
        ...
        <p><a href="{{ route('menus.index') }}">Lihat Menu</a></p>
        <p><a href="{{ route('dashboard') }}">Dasbor</a></p>
    </div>

    <svg aria-labelledby="Starry sky" alt="Starry sky" class="starry-sky" preserveAspectRatio="xMidYMid slice">

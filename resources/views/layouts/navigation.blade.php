<nav x-data="{ openMobile: false, openProfile: false }" class="bg-white fixed w-full z-50 top-0 border-b border-gray-200 shadow-sm">
        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center shrink-0">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5">
                    ...
                    <span class="hidden sm:block text-lg font-bold text-gray-900 tracking-tight">SPK Kantin</span>
                </a>
            </div>
            ...
            <div class="hidden lg:flex lg:items-center lg:gap-1 xl:gap-2">
                ...
                <a href="{{ route('saw.hasil') }}" class="px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('saw.hasil') ? 'text-white bg-[#E63912]' : 'text-gray-600 hover:bg-gray-100 hover:text-[#E63912]' }}">Rekomendasi Menu</a>
                
                <a href="{{ route('penilaian.index') }}" class="px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('penilaian.*') ? 'text-white bg-[#E63912]' : 'text-gray-600 hover:bg-gray-100 hover:text-[#E63912]' }}">Penilaian</a>

                @if(auth()->user()->role === 'admin' || auth()->user()->role === 'dev')
                    <div class="w-px h-5 bg-gray-300 mx-1"></div>
                    
                    <a href="{{ route('kriteria.index') }}" class="px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('kriteria.*') ? 'text-[#E63912] bg-red-50' : 'text-gray-600 hover:bg-gray-100 hover:text-[#E63912]' }}">Data Kriteria</a>
                    
                    <a href="{{ route('saw.index') }}" class="px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('saw.index') ? 'text-[#E63912] bg-red-50' : 'text-gray-600 hover:bg-gray-100 hover:text-[#E63912]' }}">Proses SAW</a>
                    
                    <a href="{{ route('menus.index') }}" class="px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('menus.*') ? 'text-[#E63912] bg-red-50' : 'text-gray-600 hover:bg-gray-100 hover:text-[#E63912]' }}">Data Menu</a>
                ...
                @if(auth()->user()->role === 'dev')
                    <div class="w-px h-5 bg-gray-300 mx-1"></div>
                    <a href="{{ route('logs.index') }}" class="px-3 py-2 rounded-md text-sm font-bold transition-colors {{ request()->routeIs('logs.*') ? 'text-red-700 bg-red-100' : 'text-red-500 hover:bg-red-50 hover:text-red-600' }}">Log Sistem</a>
                @endif
            </div>
    ...
    <div x-show="openMobile" x-collapse class="lg:hidden border-t border-gray-100 bg-white" style="display: none;">
        <div class="px-4 pt-2 pb-4 space-y-1 max-h-[80vh] overflow-y-auto">
            ...
            <a href="{{ route('saw.hasil') }}" class="block px-3 py-2.5 rounded-md text-base font-medium transition-colors {{ request()->routeIs('saw.hasil') ? 'text-[#E63912] bg-red-50' : 'text-gray-700 hover:bg-gray-50 hover:text-[#E63912]' }}">Rekomendasi Menu</a>
            
            <a href="{{ route('penilaian.index') }}" class="block px-3 py-2.5 rounded-md text-base font-medium transition-colors {{ request()->routeIs('penilaian.*') ? 'text-[#E63912] bg-red-50' : 'text-gray-700 hover:bg-gray-50 hover:text-[#E63912]' }}">Penilaian</a>
            ...
            @if(auth()->user()->role === 'admin' || auth()->user()->role === 'dev')
                ...
                <a href="{{ route('kriteria.index') }}" class="block px-3 py-2.5 rounded-md text-base font-medium transition-colors {{ request()->routeIs('kriteria.*') ? 'text-[#E63912] bg-red-50' : 'text-gray-700 hover:bg-gray-50 hover:text-[#E63912]' }}">Data Kriteria</a>
                
                <a href="{{ route('saw.index') }}" class="block px-3 py-2.5 rounded-md text-base font-medium transition-colors {{ request()->routeIs('saw.index') ? 'text-[#E63912] bg-red-50' : 'text-gray-700 hover:bg-gray-50 hover:text-[#E63912]' }}">Proses SAW</a>
                
                <a href="{{ route('menus.index') }}" class="block px-3 py-2.5 rounded-md text-base font-medium transition-colors {{ request()->routeIs('menus.*') ? 'text-[#E63912] bg-red-50' : 'text-gray-700 hover:bg-gray-50 hover:text-[#E63912]' }}">Data Menu</a>
            ...
            @if(auth()->user()->role === 'dev')
                ...
                <a href="{{ route('logs.index') }}" class="block px-3 py-2.5 rounded-md text-base font-bold transition-colors {{ request()->routeIs('logs.*') ? 'text-red-700 bg-red-100' : 'text-red-500 hover:bg-red-50 hover:text-red-600' }}">Log Sistem</a>
            @endif
        </div>
    </div>
</nav>
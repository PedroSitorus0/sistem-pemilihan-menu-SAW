<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('saw.hasil')" :active="request()->routeIs('saw.hasil')">
                        {{ __('Rekomendasi Menu') }}
                    </x-nav-link>
                    ...
                    @if(auth()->user()->role === 'admin' || auth()->user()->role === 'dev')
                        ...
                        <x-nav-link :href="route('saw.index')" :active="request()->routeIs('saw.index')">
                            {{ __('Proses SAW') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('saw.hasil')" :active="request()->routeIs('saw.hasil')">
                {{ __('Rekomendasi Menu') }}
            </x-responsive-nav-link>
            ...
            @if(auth()->user()->role === 'admin' || auth()->user()->role === 'dev')
                ...
                <x-responsive-nav-link :href="route('saw.index')" :active="request()->routeIs('saw.index')">
                    {{ __('Proses SAW') }}
                </x-responsive-nav-link>
            @endif
        </div>
